...
// ============================================================================
//  font8x8.c  —  Fonte bitmap 8x8 embutida (ASCII imprimivel 0x20..0x7F).
//
//  Cada glifo = 8 bytes (uma linha por byte). Convencao: bit 7 (0x80) = pixel
//  mais a ESQUERDA da linha; bit 0 (0x01) = mais a direita. Linha 0 = topo.
//  Conjunto de dominio publico no estilo da fonte 8x8 do PC (font8x8_basic).
//  Indexado por (caractere - 0x20): indice 0 = ' ' (espaco), 95 = '~'/DEL.
// ============================================================================

const uint8_t g_font8x8[96][8] = {
    ...
    { 0x00,0x00,0xFE,0xCC,0x18,0x66,0xFE,0x00 }, // 0x7A 'z'
    ...
    { 0x00,0x10,0x38,0x6C,0xC6,0xC6,0xFE,0x00 }  // 0x7F (DEL) -> triangulo
};
