// ============================================================================
//  win32k.c  —  WINDOW MANAGER + filas de mensagens + GDI (lado KERNEL).
//
//  Espelha o win32k.sys do NT: mantem a arvore de janelas (HWND), z-order e a
//  janela com foco; tem uma fila de mensagens (a thread em ring 3 a consome via
//  NtUserGetMessage, bloqueando com 'hlt' ate chegar algo); e renderiza tudo no
//  framebuffer (drivers/video.c) com a GDI de baixo nivel (fb_*). Objetos GDI
//  (HDC/HBRUSH) sao objetos do Object Manager (OB_TYPE_*).
//
//  Headless: cada operacao importante e logada na serial ([win32k]/[gdi]) para
//  comprovar a logica (a regra 3 do enunciado).
// ============================================================================
...
// ============================================================================
//  GDI: GetDC / brushes / TextOut / FillRect
// ============================================================================
